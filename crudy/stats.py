...
@app_stats.route('/login/', methods=["GET", "POST"])
def crud_login():
...
@app_stats.route('/authorize/', methods=["GET", "POST"])
def crud_authorize():
...
# CRUD create/add
@app_stats.route('/create/', methods=["POST"])
def create():
...
# CRUD read
@app_stats.route('/read/', methods=["POST"])
def read():
...
# CRUD update
@app_stats.route('/update/', methods=["POST"])
def update():
...
# CRUD delete
@app_stats.route('/delete/', methods=["POST"])
def delete():
...
@app_stats.route('/search/term/', methods=["POST"])
def search_term():
